...
namespace Fw {
    ...
    {
#if FW_USE_TIME_BASE
      assert(time1.getTimeBase() == time2.getTimeBase());
#endif
#if FW_USE_TIME_CONTEXT
      assert(time1.getContext() == time2.getContext() );
#endif
    ...
    {
#if FW_USE_TIME_BASE
      assert(a.getTimeBase() == b.getTimeBase() );
#endif
#if FW_USE_TIME_CONTEXT
    ...
    {
#if FW_USE_TIME_BASE
      assert(minuend.getTimeBase() == subtrahend.getTimeBase());
#endif
#if FW_USE_TIME_CONTEXT
      assert(minuend.getContext() == subtrahend.getContext());
#endif
    ...
    void Time::add(U32 seconds, U32 useconds) {
        this->m_seconds += seconds;
        this->m_useconds += useconds;
        assert(this->m_useconds < 1999999);
